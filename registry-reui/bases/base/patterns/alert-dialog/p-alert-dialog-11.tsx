  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="gap-0 p-0 sm:max-w-sm">
        ...
        <div className="bg-muted/60 flex flex-col items-center justify-center gap-5 p-6 style-vega:rounded-b-2xl style-nova:rounded-b-2xl style-lyra:rounded-b-none style-maia:rounded-b-2xl style-mira:rounded-b-2xl ">

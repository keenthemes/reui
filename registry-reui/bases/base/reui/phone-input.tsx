...
function InputComponent({
  ...
  return (
    <Input
      className={cn(
        "ring-none! style-vega:rounded-s-none style-maia:rounded-s-none style-nova:rounded-s-none style-lyra:rounded-s-none style-mira:rounded-s-none outline-none! focus:z-1",
        variant === "sm" &&

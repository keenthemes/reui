...
export const reui: Registry["items"] = [
  ...
  },
  {
    ...
    description: "",
    registryDependencies: ["badge", "button", "input", "popover", "separator"],
  ...
  },
  {
    ...
    title: "Data Grid Pagination",
    description: "",
    registryDependencies: ["button", "data-grid", "select", "skeleton"],
    dependencies: [],
    files: [
      {
  ...
  },
  {
    ...
    description: "",
    registryDependencies: [],
    dependencies: ["@headless-tree/core", "radix-ui"],
    files: [
      {
        path: "reui/tree.tsx",
        type: "registry:ui",

...
import { useDataGridI18n } from "@/registry-reui/bases/radix/reui/data-grid/data-grid"
              ...
              <div className="hidden space-x-1 lg:flex">
                {selectedValues.size > 2 ? (
                  <Badge variant="secondary" className="px-1 font-normal">
                    {i18n.labels.selectedCount(selectedValues.size)}
                  </Badge>
                ) : (
                  options

        ...
        <AccordionContent>
          ...
          <Accordion type="single" variant="outline" collapsible className="mt-4">
            ...
            <AccordionItem value="nested-2">
              ...
              <AccordionContent>
                Crudhunt offers optimized solutions that adapt to your backend with minimal setup.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </AccordionContent>
        ...
        <AccordionContent>
          ...
          <Accordion type="single" variant="outline" collapsible className="mt-4">
            ...
            <AccordionItem value="nested-4">
              <AccordionTrigger>Can I customize Crudhunt CRUDs?</AccordionTrigger>
              <AccordionContent>
                Yes! Crudhunt CRUDs are fully customizable to suit your project&apos;s needs.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </AccordionContent>

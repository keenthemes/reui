...
import { motion, useTransform, AnimatePresence, useMotionValue, useSpring, Easing } from 'motion/react';
      ...
      <AnimatePresence mode="wait">
        {hoveredIndex && tooltipContent && (
          <motion.div
            ...
            className={cn("absolute -top-16 left-1/2 z-50 flex -translate-x-1/2 flex-col items-center justify-center rounded-md bg-black px-4 py-2 text-xs font-medium text-white shadow-xl", finalTooltipClassName)}
          >
            <motion.div 

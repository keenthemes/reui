...
<ExamplePreview path="base-slider/default" />
...
<ComponentPreview name="base-slider" />
...
<ExamplePreview path="base-slider/range" />

<ExamplePreview path="base-slider/input" />

### Tooltip

A slider with tooltips showing current values.

<ExamplePreview path="base-slider/tooltip" />

### Ticks

A slider integrated with form validation.

<ExamplePreview path="base-slider/ticks" />

### Labels

A slider with labels showing current values.

<ExamplePreview path="base-slider/labels" />

### Rating

A slider with rating functionality.

<ExamplePreview path="base-slider/rating" />
...
<ExamplePreview path="base-slider/form" />

### Vertical

A vertical slider.

<ExamplePreview path="base-slider/vertical" />

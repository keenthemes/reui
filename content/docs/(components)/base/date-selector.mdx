...
<ComponentPreview
  ...
  align="start"
  className="**:[.preview]:h-auto! **:[.preview]:min-h-[640px]"
/>
...
<ComponentPreview styleName="base-nova" name="c-date-selector-2" />

### With Dialog

<ComponentPreview styleName="base-nova" name="c-date-selector-3" />

### With i18n Support

<ComponentPreview styleName="base-nova" name="c-date-selector-4" />

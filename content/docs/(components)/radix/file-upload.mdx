...
<ComponentPreview styleName="radix-nova" name="c-file-upload-1" />
...
<ComponentPreview styleName="radix-nova" name="c-file-upload-2" />

### Compact Upload

<ComponentPreview styleName="radix-nova" name="c-file-upload-3" />

...
<ComponentPreview styleName="radix-nova" name="c-icon-stack-1" />
...
<ComponentPreview styleName="radix-nova" name="c-icon-stack-2" />

### Colors

<ComponentPreview styleName="radix-nova" name="c-icon-stack-3" />

### Icon Badge

<ComponentPreview styleName="radix-nova" name="c-icon-stack-4" />
...
<ComponentPreview styleName="radix-nova" name="c-icon-stack-6" />

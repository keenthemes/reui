...
<ComponentPreview styleName="base-nova" name="c-alert-1" />
...
<ComponentPreview styleName="base-nova" name="c-alert-2" />

### With Action Buttons

<ComponentPreview styleName="base-nova" name="c-alert-3" />

### With Extended Message

<ComponentPreview styleName="base-nova" name="c-alert-4" />

### With Title and Action Buttons

<ComponentPreview styleName="base-nova" name="c-alert-10" />

### With Description and Action Buttons

<ComponentPreview styleName="base-nova" name="c-alert-11" />

### Info Alert

<ComponentPreview styleName="base-nova" name="c-alert-5" />

### Success Alert

<ComponentPreview styleName="base-nova" name="c-alert-6" />

### Warning Alert

<ComponentPreview styleName="base-nova" name="c-alert-7" />

### Destructive Alert

<ComponentPreview styleName="base-nova" name="c-alert-8" />

### Invert Alert

<ComponentPreview styleName="base-nova" name="c-alert-9" />

...
You can integrate ReUI using the [**shadcn CLI**](https://ui.shadcn.com/docs/cli) for automation or by manual installation for full control.
Both methods apply to everything in [Docs](/docs/) and the [component catalog](/components), including `c-*` blocks you install with `@reui/…`.
...
For these custom color tokens, see the [Styling guide](/docs/styling).

    ...
    <div className="group/picker relative">
      <Picker>
        <PickerTrigger>
          ...
          <div className="text-site-foreground pointer-events-none absolute top-1/2 right-2 flex size-4 -translate-y-1/2 items-center justify-center text-base select-none">
            <svg
            ...
            >
              <path
                ...
                className="data-[accent=bold]:fill-site-foreground fill-site-muted-foreground/30"
              ></path>
              <path

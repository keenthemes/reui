...
import { getRadiusForStyleSelection } from "@/app/(create)/lib/style-radius"
...
export function StylePicker({
  ...
  const handleValueChange = React.useCallback(
    (value: string) => {
      ...
      const nextRadius = getRadiusForStyleSelection(newStyle)
      setParams({ style: newStyle, radius: nextRadius })
      setConfig((prev) => ({
        ...prev,
        style: newStyle,
        radius: nextRadius,
